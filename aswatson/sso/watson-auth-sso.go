...
const (
	...
	defaultForgetMatchingLength = 3
)

type WatsonSSORequestProcessor struct {
...
type RequestBody struct {
	...
	ForgetMatchingLength int    `json:"forgetMatchingLength"`
}

func (w *WatsonSSORequestProcessor) newRequestBody(rawHeaders map[string][]byte) *RequestBody {
...
func (w *WatsonSSORequestProcessor) ssoURL() string {
	return fmt.Sprintf("%s%s", aswatson.NewHost(w.Host), aswatson.NewPath(w.Path))
}

func (w *WatsonSSORequestProcessor) ssoAuth(ctx context.Context, rawHeaders map[string][]byte) (*http.Response, error) {
...
func (w *WatsonSSORequestProcessor) ssoCheck(ctx *ep.RequestContext, rawHeaders map[string][]byte) error {
...
func (w *WatsonSSORequestProcessor) GetName() string {
	return "watson-auth-sso"
}

func (w *WatsonSSORequestProcessor) GetOptions() *ep.ProcessingOptions {
	return w.opts
}

func (w *WatsonSSORequestProcessor) ProcessRequestHeaders(ctx *ep.RequestContext, headers ep.AllHeaders) error {
...
func (w *WatsonSSORequestProcessor) ProcessRequestBody(ctx *ep.RequestContext, body []byte) error {
	return ctx.ContinueRequest()
}

func (w *WatsonSSORequestProcessor) ProcessRequestTrailers(ctx *ep.RequestContext, trailers ep.AllHeaders) error {
	return ctx.ContinueRequest()
}

func (w *WatsonSSORequestProcessor) ProcessResponseHeaders(ctx *ep.RequestContext, headers ep.AllHeaders) error {
	return ctx.ContinueRequest()
}

func (w *WatsonSSORequestProcessor) ProcessResponseBody(ctx *ep.RequestContext, body []byte) error {
	return ctx.ContinueRequest()
}

func (w *WatsonSSORequestProcessor) ProcessResponseTrailers(ctx *ep.RequestContext, trailers ep.AllHeaders) error {
	return ctx.ContinueRequest()
}

func (w *WatsonSSORequestProcessor) Init(args []string, rootCmd *flag.FlagSet, opts *ep.ProcessingOptions) error {
...
func (w *WatsonSSORequestProcessor) Finish() {
